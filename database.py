...
with app.app_context():
  ...
  mister_3 = User(username = 'Mr 3', full_name = 'demo land', email = 'mister3@demo.com',
   belt_color = 'Blue', affiliation ='Gracie Barra', avatar = 'https://jiutube.s3.us-east-2.amazonaws.com/Galdino_Anime_Infobox.png', encrypted_password=bcrypt.hashpw(
            "password".encode('utf-8'), bcrypt.gensalt(14)))

  miss_monday = User(username = 'Miss Monday', full_name = 'demo land', email = 'missmonday@demo.com',
   belt_color = 'Purple', affiliation ='Alliance', avatar = 'https://jiutube.s3.us-east-2.amazonaws.com/miss+monday.png', encrypted_password=bcrypt.hashpw(
            "password".encode('utf-8'), bcrypt.gensalt(14)))

  Zackitty = User(username = 'Zackitty', full_name = 'Zachery Haley', email = 'theelfenliedpictureshow@yahoo.com',
   belt_color = 'Brown', affiliation ='GFTeam', avatar = 'https://jiutube.s3.us-east-2.amazonaws.com/75540036_10163916409385354_7059600026032406528_n.jpg', encrypted_password=bcrypt.hashpw(
